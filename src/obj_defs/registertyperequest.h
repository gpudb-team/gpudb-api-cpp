...
#ifndef REGISTERTYPEREQUEST_TEMP_H__H_
#define REGISTERTYPEREQUEST_TEMP_H__H_
...
struct register_type_request {
    ...
    {
        static const std::string str("register_type_request");
        return str;
    }
    static const std::string& schema_str(void)
    {
        static const std::string str("{\"type\":\"record\",\"name\":\"register_type_request\",\"fields\":[{\"name\":\"type_definition\",\"type\":\"string\"},{\"name\":\"annotation\",\"type\":\"string\"},{\"name\":\"label\",\"type\":\"string\"},{\"name\":\"semantic_type\",\"type\":\"string\"}]}");
        return str;
    }
...
namespace avro {
template<> struct codec_traits<gpudb::register_type_request> {
    static void encode(Encoder& e, const gpudb::register_type_request& v) {
        avro::encode(e, v.type_definition);
        avro::encode(e, v.annotation);
        avro::encode(e, v.label);
        avro::encode(e, v.semantic_type);
    }
    static void decode(Decoder& d, gpudb::register_type_request& v) {
