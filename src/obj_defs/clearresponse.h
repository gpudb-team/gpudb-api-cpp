...
#ifndef CLEARRESPONSE_TEMP_H__H_
#define CLEARRESPONSE_TEMP_H__H_
...
struct clear_response {
    ...
    {
        static const std::string str("clear_response");
        return str;
    }
    static const std::string& schema_str(void)
    {
        static const std::string str("{\"type\":\"record\",\"name\":\"clear_response\",\"fields\":[{\"name\":\"status\",\"type\":\"string\"},{\"name\":\"set_id\",\"type\":\"string\"}]}");
        return str;
    }
...
namespace avro {
template<> struct codec_traits<gpudb::clear_response> {
    static void encode(Encoder& e, const gpudb::clear_response& v) {
        avro::encode(e, v.status);
        avro::encode(e, v.set_id);
    }
    static void decode(Decoder& d, gpudb::clear_response& v) {
